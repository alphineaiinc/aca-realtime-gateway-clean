...
export declare class Transcriptions extends APIResource {
     ...
     */
    create(body: TranscriptionCreateParams<'json' | undefined>, options?: RequestOptions): APIPromise<Transcription>;
    create(body: TranscriptionCreateParams<'verbose_json'>, options?: RequestOptions): APIPromise<TranscriptionVerbose>;
    create(body: TranscriptionCreateParams<'srt' | 'vtt' | 'text'>, options?: RequestOptions): APIPromise<string>;
