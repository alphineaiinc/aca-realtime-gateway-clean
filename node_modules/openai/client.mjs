...
import { validatePositiveInteger, isAbsoluteURL, hasOwn } from "./internal/utils/values.mjs";
...
const parseLogLevel = (maybeLevel, sourceName, client) => {
    ...
    loggerFor(client).warn(`${sourceName} was set to ${JSON.stringify(maybeLevel)}, expected one of ${JSON.stringify(Object.keys(levels))}`);
    return undefined;
};
/**
