...
router.use(
  rateLimitIP({
    windowMs: 60 * 60 * 1000,
    max: parseInt(process.env.DEMO_TOKEN_MAX_PER_HOUR || "10", 10),
    keyPrefix: "demo_token_h",
  })
);
...
router.use(
  rateLimitIP({
    windowMs: 60 * 1000,
    max: parseInt(process.env.DEMO_TOKEN_MAX_PER_MIN || "2", 10),
    keyPrefix: "demo_token_m",
  })
);
